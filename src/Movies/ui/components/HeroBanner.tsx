    ...
    return (
      <div className="relative w-full h-[70vh] min-h-[500px] flex items-end pb-16">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          />
          {/* The smooth transition gradient matching the slate-950 background */}
          <div className="absolute inset-0 bg-linear-to-t from-slate-950 via-slate-950/50 to-transparent" />
        </div>
        
        {/* Content strictly constrained to max-width for enterprise alignment */}
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full">
          ...
          <div className="flex gap-4">
            ...
            <button className="px-6 py-2.5 bg-slate-800/80 hover:bg-slate-700 text-white text-sm font-semibold rounded-full transition-all border border-slate-700 backdrop-blur-sm flex items-center gap-2">
              + Watchlist
            </button>
          </div>
        </div>
